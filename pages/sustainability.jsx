...
export default function ExpoPage({ shoes }) {
  const meta = {
    ...
    description: 'Boots and shoes contructed with recycled materials.',
  }

  return (
    <Page meta={meta}>
      <Layout>
        <Header hero="Sustainable Hiking Boots" description={meta.description} />
...
const query = gql`
  {
    shoes(first: 100, where: { categoryIn: [30, 34, 31, 32] }) {
      nodes {
        title
        slug
        databaseId
